...
- **Format**: Bar chart with annotations
...
#### **4. Scaling Analysis** 📊 ⭐ **MOST IMPORTANT**
...
### **For Development**
- Start with `--users 5-10` for quick feedback
- Use `virtual_user_load_test.py` for consistent results
...
python loadtesting/virtual_user_load_test.py --scenario "CI Check" --users 25
# Fail build if average response time >2000ms or failure rate >1%
```
